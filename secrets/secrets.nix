...
in
{
  ...
  # UniFi Network local API key for the UDR7, created at 192.168.1.1 under
  # Settings -> Control Plane -> Integrations. Not used by any host config;
  # decrypted on demand.
  "udr7-api-key.age".publicKeys = [
    chungito
    fw13
  ];
}
